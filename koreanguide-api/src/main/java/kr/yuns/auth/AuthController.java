...
import kr.yuns.auth.data.request.ValidateEmailRequestDto;
import kr.yuns.auth.data.request.ValidateRequestDto;
...
public class AuthController {
    ...
    public void exceptionTest() throws RuntimeException{
        throw new RuntimeException("Access Denied; You don't have permission to access this page");
    }
